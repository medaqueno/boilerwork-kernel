...
class DataProvider
{
    ...
    protected static $data = [
        ...
        ['ZA', 'ZAF', '', "South Africa"],
        ['ZM', 'ZMB', '', "Zambia"],
        ['ZR', 'ZAR', '', "Congo (Democratic Republic of the)"],
        ['ZW', 'ZWE', '', "Zimbabwe"],
    ];

    public static function fromIso31661Alpha2Code(Iso31661Alpha2Code $code)
    {
        foreach (static::$data as $country) {
            if ($code->equals(new Iso31661Alpha2Code($country[0]))) {
                return $country;
            }
        }
    }
    ...
    {
        foreach (static::$data as $country) {
            if ($code->equals(new Iso31661Alpha3Code($country[1]))) {
                return $country;
            }
        }
    }
